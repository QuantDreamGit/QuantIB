...
PROTOBUF_CONSTEXPR Order::Order(
  ...
  , /*decltype(_impl_.hedgemaxsize_)*/0} {}
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 30, 180, -1, sizeof(::protobuf::Order)},
};
...
const ::_pbi::DescriptorTable descriptor_table_Order_2eproto = {
    false, false, 7440, descriptor_table_protodef_Order_2eproto,
    "Order.proto",
...
class Order::_Internal {
 public:
  ...
  static void set_has_hedgemaxsize(HasBits* has_bits) {
    (*has_bits)[4] |= 2048u;
  }
};
...
Order::Order(const Order& from)
  ...
  ::memcpy(&_impl_.clientid_, &from._impl_.clientid_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.hedgemaxsize_) -
    reinterpret_cast<char*>(&_impl_.clientid_)) + sizeof(_impl_.hedgemaxsize_));
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 144:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 128)) {
          _Internal::set_has_hedgemaxsize(&_impl_._has_bits_);
          _impl_.hedgemaxsize_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Order::_InternalSerialize(
  ...
  // optional int32 hedgeMaxSize = 144;
  if (_internal_has_hedgemaxsize()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(144, this->_internal_hedgemaxsize(), target);
  }

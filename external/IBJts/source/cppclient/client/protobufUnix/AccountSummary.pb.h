...
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_AccountSummary_2eproto;
}  // extern "C"
namespace protobuf {
...
template <typename Arg_, typename... Args_>
PROTOBUF_ALWAYS_INLINE void AccountSummary::set_tag(Arg_&& arg, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.tag_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:protobuf.AccountSummary.tag)
}
inline ::std::string* PROTOBUF_NONNULL AccountSummary::mutable_tag()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::std::string* PROTOBUF_NONNULL AccountSummary::_internal_mutable_tag() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000002u;
  return _impl_.tag_.Mutable( GetArena());
}
inline ::std::string* PROTOBUF_NULLABLE AccountSummary::release_tag() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline void AccountSummary::set_allocated_tag(::std::string* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000002u;
  } else {

...
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_MarketDepthL2_2eproto;
}  // extern "C"
namespace protobuf {
class MarketDepthL2;
struct MarketDepthL2DefaultTypeInternal;
extern MarketDepthL2DefaultTypeInternal _MarketDepthL2_default_instance_;
extern const ::google::protobuf::internal::ClassDataFull MarketDepthL2_class_data_;
}  // namespace protobuf
namespace google {
namespace protobuf {
}  // namespace protobuf
...
/* @@protoc_insertion_point(class_definition:protobuf.MarketDepthL2) */ {
 public:
  ...
  void operator delete(MarketDepthL2* PROTOBUF_NONNULL msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  explicit PROTOBUF_CONSTEXPR MarketDepthL2(::google::protobuf::internal::ConstantInitialized);
  ...
  inline void Swap(MarketDepthL2* PROTOBUF_NONNULL other) {
  ...
  void UnsafeArenaSwap(MarketDepthL2* PROTOBUF_NONNULL other) {
    if (other == this) return;
  ...
  MarketDepthL2* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
  ...
  void InternalSwap(MarketDepthL2* PROTOBUF_NONNULL other);
 private:
  template <typename T>
 ...
 protected:
  explicit MarketDepthL2(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  MarketDepthL2(::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const MarketDepthL2& from);
  MarketDepthL2(
      ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, MarketDepthL2&& from) noexcept
      : MarketDepthL2(arena) {
    *this = ::std::move(from);
  }
...
inline ::protobuf::MarketDepthData* PROTOBUF_NULLABLE MarketDepthL2::release_marketdepthdata() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::protobuf::MarketDepthData* PROTOBUF_NULLABLE MarketDepthL2::unsafe_arena_release_marketdepthdata() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::protobuf::MarketDepthData* PROTOBUF_NONNULL MarketDepthL2::_internal_mutable_marketdepthdata() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::protobuf::MarketDepthData* PROTOBUF_NONNULL MarketDepthL2::mutable_marketdepthdata()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  _impl_._has_bits_[0] |= 0x00000001u;
...
inline void MarketDepthL2::set_allocated_marketdepthdata(::protobuf::MarketDepthData* PROTOBUF_NULLABLE value) {

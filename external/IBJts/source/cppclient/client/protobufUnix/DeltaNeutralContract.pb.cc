...
PROTOBUF_CONSTEXPR DeltaNeutralContract::DeltaNeutralContract(::_pbi::ConstantInitialized)
    ...
    : ::google::protobuf::Message(DeltaNeutralContract_class_data_.base()),
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::protobuf::DeltaNeutralContract)},
};
...
DeltaNeutralContract::DeltaNeutralContract(::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, DeltaNeutralContract_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
...
DeltaNeutralContract::DeltaNeutralContract(
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const DeltaNeutralContract& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, DeltaNeutralContract_class_data_.base()),
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena),
...
PROTOBUF_NDEBUG_INLINE DeltaNeutralContract::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
      : _cached_size_{0} {}

inline void DeltaNeutralContract::SharedCtor(::_pb::Arena* PROTOBUF_NULLABLE arena) {
...
inline void* PROTOBUF_NONNULL DeltaNeutralContract::PlacementNew_(
...
constexpr auto DeltaNeutralContract::InternalGenerateClassData_() {
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull DeltaNeutralContract_class_data_ =
        DeltaNeutralContract::InternalGenerateClassData_();

PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
DeltaNeutralContract::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&DeltaNeutralContract_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(DeltaNeutralContract_class_data_.tc_table);
  return DeltaNeutralContract_class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<2, 3, 0, 0, 2>
DeltaNeutralContract::_table_ = {
  {
    ...
    DeltaNeutralContract_class_data_.base(),
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL DeltaNeutralContract::_InternalSerialize(
...
void DeltaNeutralContract::InternalSwap(DeltaNeutralContract* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  using ::std::swap;

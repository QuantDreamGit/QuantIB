...
PROTOBUF_CONSTEXPR MarketDataType::MarketDataType(::_pbi::ConstantInitialized)
    ...
    : ::google::protobuf::Message(MarketDataType_class_data_.base()),
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::protobuf::MarketDataType)},
};
...
MarketDataType::MarketDataType(::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, MarketDataType_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
...
MarketDataType::MarketDataType(
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const MarketDataType& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, MarketDataType_class_data_.base()),
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena),
...
PROTOBUF_NDEBUG_INLINE MarketDataType::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
      : _cached_size_{0} {}

inline void MarketDataType::SharedCtor(::_pb::Arena* PROTOBUF_NULLABLE arena) {
...
inline void* PROTOBUF_NONNULL MarketDataType::PlacementNew_(
...
constexpr auto MarketDataType::InternalGenerateClassData_() {
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull MarketDataType_class_data_ =
        MarketDataType::InternalGenerateClassData_();

PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
MarketDataType::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&MarketDataType_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(MarketDataType_class_data_.tc_table);
  return MarketDataType_class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<1, 2, 0, 0, 2>
MarketDataType::_table_ = {
  {
    ...
    MarketDataType_class_data_.base(),
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL MarketDataType::_InternalSerialize(
...
void MarketDataType::InternalSwap(MarketDataType* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  using ::std::swap;

...
PROTOBUF_NDEBUG_INLINE Execution::Impl_::Impl_(
    ...
    const ::protobuf::Execution& from_msg)
...
const ::_pbi::TcParseTable<5, 21, 0, 119, 2>
Execution::_table_ = {
  {
...
::size_t Execution::ByteSizeLong() const {
  ...
  total_size += ::absl::popcount(0x0000a000u & cached_has_bits) * 9;
  ...
  if ((cached_has_bits & 0x00180000u) != 0) {
    // optional int32 lastLiquidity = 18;
    if ((cached_has_bits & 0x00080000u) != 0) {

...
PROTOBUF_CONSTEXPR ComboLeg::ComboLeg(::_pbi::ConstantInitialized)
    ...
    : ::google::protobuf::Message(ComboLeg_class_data_.base()),
...
ComboLeg::ComboLeg(::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, ComboLeg_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
...
PROTOBUF_NDEBUG_INLINE ComboLeg::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::protobuf::ComboLeg& from_msg)
...
inline void ComboLeg::SharedCtor(::_pb::Arena* PROTOBUF_NULLABLE arena) {
...
inline void* PROTOBUF_NONNULL ComboLeg::PlacementNew_(
...
constexpr auto ComboLeg::InternalGenerateClassData_() {
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull ComboLeg_class_data_ =
        ComboLeg::InternalGenerateClassData_();

PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
ComboLeg::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&ComboLeg_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(ComboLeg_class_data_.tc_table);
  return ComboLeg_class_data_.base();
}
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL ComboLeg::_InternalSerialize(
...
void ComboLeg::InternalSwap(ComboLeg* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  using ::std::swap;
  auto* arena = GetArena();

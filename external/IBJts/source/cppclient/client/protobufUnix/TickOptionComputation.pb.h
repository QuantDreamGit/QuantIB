...
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_TickOptionComputation_2eproto;
}  // extern "C"
namespace protobuf {
...
extern const ::google::protobuf::internal::ClassDataFull TickOptionComputation_class_data_;
}  // namespace protobuf
namespace google {
namespace protobuf {
}  // namespace protobuf
...
/* @@protoc_insertion_point(class_definition:protobuf.TickOptionComputation) */ {
 public:
  ...
  void operator delete(TickOptionComputation* PROTOBUF_NONNULL msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  explicit PROTOBUF_CONSTEXPR TickOptionComputation(::google::protobuf::internal::ConstantInitialized);
  ...
  inline void Swap(TickOptionComputation* PROTOBUF_NONNULL other) {
  ...
  void UnsafeArenaSwap(TickOptionComputation* PROTOBUF_NONNULL other) {
    if (other == this) return;
  ...
  TickOptionComputation* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
  ...
  void InternalSwap(TickOptionComputation* PROTOBUF_NONNULL other);
 private:
  template <typename T>
 ...
 protected:
  explicit TickOptionComputation(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  TickOptionComputation(::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const TickOptionComputation& from);
  TickOptionComputation(
      ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, TickOptionComputation&& from) noexcept

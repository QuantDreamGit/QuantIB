...
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_TickAttribLast_2eproto;
}  // extern "C"
namespace protobuf {
...
extern const ::google::protobuf::internal::ClassDataFull TickAttribLast_class_data_;
}  // namespace protobuf
namespace google {
namespace protobuf {
}  // namespace protobuf
...
/* @@protoc_insertion_point(class_definition:protobuf.TickAttribLast) */ {
 public:
  ...
  void operator delete(TickAttribLast* PROTOBUF_NONNULL msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  explicit PROTOBUF_CONSTEXPR TickAttribLast(::google::protobuf::internal::ConstantInitialized);
  ...
  inline void Swap(TickAttribLast* PROTOBUF_NONNULL other) {
  ...
  void UnsafeArenaSwap(TickAttribLast* PROTOBUF_NONNULL other) {
    if (other == this) return;
  ...
  TickAttribLast* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
  ...
  void InternalSwap(TickAttribLast* PROTOBUF_NONNULL other);
 private:
  template <typename T>
 ...
 protected:
  explicit TickAttribLast(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  TickAttribLast(::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const TickAttribLast& from);
  TickAttribLast(
      ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, TickAttribLast&& from) noexcept

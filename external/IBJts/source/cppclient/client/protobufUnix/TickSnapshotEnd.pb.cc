...
PROTOBUF_CONSTEXPR TickSnapshotEnd::TickSnapshotEnd(::_pbi::ConstantInitialized)
    ...
    : ::google::protobuf::Message(TickSnapshotEnd_class_data_.base()),
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::protobuf::TickSnapshotEnd)},
};
...
TickSnapshotEnd::TickSnapshotEnd(::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, TickSnapshotEnd_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
...
TickSnapshotEnd::TickSnapshotEnd(
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const TickSnapshotEnd& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, TickSnapshotEnd_class_data_.base()),
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena),
...
PROTOBUF_NDEBUG_INLINE TickSnapshotEnd::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
      : _cached_size_{0} {}

inline void TickSnapshotEnd::SharedCtor(::_pb::Arena* PROTOBUF_NULLABLE arena) {
...
inline void* PROTOBUF_NONNULL TickSnapshotEnd::PlacementNew_(
...
constexpr auto TickSnapshotEnd::InternalGenerateClassData_() {
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull TickSnapshotEnd_class_data_ =
        TickSnapshotEnd::InternalGenerateClassData_();

PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
TickSnapshotEnd::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&TickSnapshotEnd_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(TickSnapshotEnd_class_data_.tc_table);
  return TickSnapshotEnd_class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<0, 1, 0, 0, 2>
TickSnapshotEnd::_table_ = {
  {
    ...
    TickSnapshotEnd_class_data_.base(),
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL TickSnapshotEnd::_InternalSerialize(
...
void TickSnapshotEnd::InternalSwap(TickSnapshotEnd* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  using ::std::swap;

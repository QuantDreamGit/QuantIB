...
PROTOBUF_CONSTEXPR MarketDataTypeRequest::MarketDataTypeRequest(::_pbi::ConstantInitialized)
    ...
    : ::google::protobuf::Message(MarketDataTypeRequest_class_data_.base()),
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::protobuf::MarketDataTypeRequest)},
};
...
MarketDataTypeRequest::MarketDataTypeRequest(::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, MarketDataTypeRequest_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
...
MarketDataTypeRequest::MarketDataTypeRequest(
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const MarketDataTypeRequest& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, MarketDataTypeRequest_class_data_.base()),
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena),
...
PROTOBUF_NDEBUG_INLINE MarketDataTypeRequest::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
      : _cached_size_{0} {}

inline void MarketDataTypeRequest::SharedCtor(::_pb::Arena* PROTOBUF_NULLABLE arena) {
...
inline void* PROTOBUF_NONNULL MarketDataTypeRequest::PlacementNew_(
...
constexpr auto MarketDataTypeRequest::InternalGenerateClassData_() {
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull MarketDataTypeRequest_class_data_ =
        MarketDataTypeRequest::InternalGenerateClassData_();

PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
MarketDataTypeRequest::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&MarketDataTypeRequest_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(MarketDataTypeRequest_class_data_.tc_table);
  return MarketDataTypeRequest_class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<0, 1, 0, 0, 2>
MarketDataTypeRequest::_table_ = {
  {
    ...
    MarketDataTypeRequest_class_data_.base(),
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL MarketDataTypeRequest::_InternalSerialize(
...
void MarketDataTypeRequest::InternalSwap(MarketDataTypeRequest* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  using ::std::swap;

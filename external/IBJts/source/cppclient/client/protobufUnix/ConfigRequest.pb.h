...
PROTOBUF_NAMESPACE_OPEN
template<> ::protobuf::ConfigRequest* Arena::CreateMaybeMessage<::protobuf::ConfigRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace protobuf {
...
class ConfigRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:protobuf.ConfigRequest) */ {
 public:
...
// optional int32 reqId = 1;
inline bool ConfigRequest::_internal_has_reqid() const {

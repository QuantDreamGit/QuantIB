...
PROTOBUF_CONSTEXPR CompletedOrdersRequest::CompletedOrdersRequest(::_pbi::ConstantInitialized)
    ...
    : ::google::protobuf::Message(CompletedOrdersRequest_class_data_.base()),
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::protobuf::CompletedOrdersRequest)},
};
...
CompletedOrdersRequest::CompletedOrdersRequest(::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, CompletedOrdersRequest_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
...
CompletedOrdersRequest::CompletedOrdersRequest(
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const CompletedOrdersRequest& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, CompletedOrdersRequest_class_data_.base()),
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena),
...
PROTOBUF_NDEBUG_INLINE CompletedOrdersRequest::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
      : _cached_size_{0} {}

inline void CompletedOrdersRequest::SharedCtor(::_pb::Arena* PROTOBUF_NULLABLE arena) {
...
inline void* PROTOBUF_NONNULL CompletedOrdersRequest::PlacementNew_(
...
constexpr auto CompletedOrdersRequest::InternalGenerateClassData_() {
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull CompletedOrdersRequest_class_data_ =
        CompletedOrdersRequest::InternalGenerateClassData_();

PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
CompletedOrdersRequest::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&CompletedOrdersRequest_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(CompletedOrdersRequest_class_data_.tc_table);
  return CompletedOrdersRequest_class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<0, 1, 0, 0, 2>
CompletedOrdersRequest::_table_ = {
  {
    ...
    CompletedOrdersRequest_class_data_.base(),
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL CompletedOrdersRequest::_InternalSerialize(
...
void CompletedOrdersRequest::InternalSwap(CompletedOrdersRequest* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  using ::std::swap;

...
PROTOBUF_CONSTEXPR OrderAllocation::OrderAllocation(::_pbi::ConstantInitialized)
    ...
    : ::google::protobuf::Message(OrderAllocation_class_data_.base()),
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::protobuf::OrderAllocation)},
};
...
OrderAllocation::OrderAllocation(::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, OrderAllocation_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
...
PROTOBUF_NDEBUG_INLINE OrderAllocation::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::protobuf::OrderAllocation& from_msg)
...
inline void OrderAllocation::SharedCtor(::_pb::Arena* PROTOBUF_NULLABLE arena) {
...
inline void* PROTOBUF_NONNULL OrderAllocation::PlacementNew_(
...
constexpr auto OrderAllocation::InternalGenerateClassData_() {
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull OrderAllocation_class_data_ =
        OrderAllocation::InternalGenerateClassData_();

PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
OrderAllocation::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&OrderAllocation_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(OrderAllocation_class_data_.tc_table);
  return OrderAllocation_class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<3, 7, 0, 106, 2>
OrderAllocation::_table_ = {
  {
    ...
    OrderAllocation_class_data_.base(),
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL OrderAllocation::_InternalSerialize(
...
void OrderAllocation::InternalSwap(OrderAllocation* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  using ::std::swap;
  auto* arena = GetArena();

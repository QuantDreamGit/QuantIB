...
PROTOBUF_CONSTEXPR TickString::TickString(::_pbi::ConstantInitialized)
    ...
    : ::google::protobuf::Message(TickString_class_data_.base()),
...
TickString::TickString(::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, TickString_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
...
PROTOBUF_NDEBUG_INLINE TickString::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::protobuf::TickString& from_msg)
...
inline void TickString::SharedCtor(::_pb::Arena* PROTOBUF_NULLABLE arena) {
...
inline void* PROTOBUF_NONNULL TickString::PlacementNew_(
...
constexpr auto TickString::InternalGenerateClassData_() {
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull TickString_class_data_ =
        TickString::InternalGenerateClassData_();

PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
TickString::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&TickString_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(TickString_class_data_.tc_table);
  return TickString_class_data_.base();
}
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL TickString::_InternalSerialize(
...
void TickString::InternalSwap(TickString* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  using ::std::swap;
  auto* arena = GetArena();

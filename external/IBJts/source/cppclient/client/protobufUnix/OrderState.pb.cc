...
static const ::_pbi::DescriptorTable* PROTOBUF_NONNULL const
    descriptor_table_OrderState_2eproto_deps[1] = {
...
PROTOBUF_NDEBUG_INLINE OrderState::Impl_::Impl_(
    ...
    const ::protobuf::OrderState& from_msg)
...
const ::_pbi::TcParseTable<5, 30, 1, 161, 2>
OrderState::_table_ = {
  {
...
::size_t OrderState::ByteSizeLong() const {
  ...
  cached_has_bits = this_._impl_._has_bits_[0];
  total_size += ::absl::popcount(0x1ff00000u & cached_has_bits) * 10;
  total_size += ::absl::popcount(0x000fff00u & cached_has_bits) * 9;
  if ((cached_has_bits & 0x000000ffu) != 0) {
    // optional string status = 1;
    if ((cached_has_bits & 0x00000001u) != 0) {

...
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_MarketDepthRequest_2eproto;
}  // extern "C"
namespace protobuf {
...
extern const ::google::protobuf::internal::ClassDataFull MarketDepthRequest_class_data_;
...
extern const ::google::protobuf::internal::ClassDataFull MarketDepthRequest_MarketDepthOptionsEntry_DoNotUse_class_data_;
}  // namespace protobuf
namespace google {
namespace protobuf {
}  // namespace protobuf
...
class MarketDepthRequest_MarketDepthOptionsEntry_DoNotUse final
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR MarketDepthRequest_MarketDepthOptionsEntry_DoNotUse(::google::protobuf::internal::ConstantInitialized);
  explicit MarketDepthRequest_MarketDepthOptionsEntry_DoNotUse(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  static constexpr const void* PROTOBUF_NONNULL internal_default_instance() {
    return &_MarketDepthRequest_MarketDepthOptionsEntry_DoNotUse_default_instance_;
  }
...
/* @@protoc_insertion_point(class_definition:protobuf.MarketDepthRequest) */ {
 public:
  ...
  void operator delete(MarketDepthRequest* PROTOBUF_NONNULL msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR MarketDepthRequest(::google::protobuf::internal::ConstantInitialized);
  ...
  inline void Swap(MarketDepthRequest* PROTOBUF_NONNULL other) {
  ...
  void UnsafeArenaSwap(MarketDepthRequest* PROTOBUF_NONNULL other) {
    if (other == this) return;
  ...
  MarketDepthRequest* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
  ...
  void InternalSwap(MarketDepthRequest* PROTOBUF_NONNULL other);
 private:
  template <typename T>
 ...
 protected:
  explicit MarketDepthRequest(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  MarketDepthRequest(::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const MarketDepthRequest& from);
  MarketDepthRequest(
      ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, MarketDepthRequest&& from) noexcept
 ...
 public:
  ...
  ::google::protobuf::Map<std::string, std::string>* PROTOBUF_NONNULL mutable_marketdepthoptions();

  private:
  const ::google::protobuf::Map<std::string, std::string>& _internal_marketdepthoptions() const;
  ::google::protobuf::Map<std::string, std::string>* PROTOBUF_NONNULL _internal_mutable_marketdepthoptions();
...
inline ::protobuf::Contract* PROTOBUF_NULLABLE MarketDepthRequest::release_contract() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::protobuf::Contract* PROTOBUF_NULLABLE MarketDepthRequest::unsafe_arena_release_contract() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::protobuf::Contract* PROTOBUF_NONNULL MarketDepthRequest::_internal_mutable_contract() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::protobuf::Contract* PROTOBUF_NONNULL MarketDepthRequest::mutable_contract()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  _impl_._has_bits_[0] |= 0x00000001u;
...
inline void MarketDepthRequest::set_allocated_contract(::protobuf::Contract* PROTOBUF_NULLABLE value) {
...
inline ::google::protobuf::Map<std::string, std::string>* PROTOBUF_NONNULL MarketDepthRequest::_internal_mutable_marketdepthoptions() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _impl_.marketdepthoptions_.MutableMap();
}
inline ::google::protobuf::Map<std::string, std::string>* PROTOBUF_NONNULL MarketDepthRequest::mutable_marketdepthoptions()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {

...
PROTOBUF_CONSTEXPR CompletedOrder::CompletedOrder(::_pbi::ConstantInitialized)
    ...
    : ::google::protobuf::Message(CompletedOrder_class_data_.base()),
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::protobuf::CompletedOrder)},
};
...
static const ::_pbi::DescriptorTable* PROTOBUF_NONNULL const
    descriptor_table_CompletedOrder_2eproto_deps[3] = {
...
CompletedOrder::CompletedOrder(::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, CompletedOrder_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
...
PROTOBUF_NDEBUG_INLINE CompletedOrder::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::protobuf::CompletedOrder& from_msg)
...
CompletedOrder::CompletedOrder(
  ...
  _impl_.order_ = ((cached_has_bits & 0x00000002u) != 0)
                ...
                : nullptr;
  _impl_.orderstate_ = ((cached_has_bits & 0x00000004u) != 0)
                ? ::google::protobuf::Message::CopyConstruct(arena, *from._impl_.orderstate_)
                : nullptr;
...
inline void CompletedOrder::SharedCtor(::_pb::Arena* PROTOBUF_NULLABLE arena) {
...
inline void* PROTOBUF_NONNULL CompletedOrder::PlacementNew_(
...
constexpr auto CompletedOrder::InternalGenerateClassData_() {
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull CompletedOrder_class_data_ =
        CompletedOrder::InternalGenerateClassData_();

PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
CompletedOrder::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&CompletedOrder_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(CompletedOrder_class_data_.tc_table);
  return CompletedOrder_class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<2, 3, 3, 0, 2>
CompletedOrder::_table_ = {
  {
    ...
    CompletedOrder_class_data_.base(),
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL CompletedOrder::_InternalSerialize(
  ...
  if ((cached_has_bits & 0x00000007u) != 0) {
    ...
    if ((cached_has_bits & 0x00000004u) != 0) {
      ...
      if (_this->_impl_.orderstate_ == nullptr) {
        _this->_impl_.orderstate_ = ::google::protobuf::Message::CopyConstruct(arena, *from._impl_.orderstate_);
      } else {
...
void CompletedOrder::InternalSwap(CompletedOrder* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  using ::std::swap;

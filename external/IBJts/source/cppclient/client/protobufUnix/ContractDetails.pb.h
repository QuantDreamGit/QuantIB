...
class ContractDetails final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_lastpriceprecision(ArgT0&& arg0, ArgT... args);
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_lastpriceprecision(const std::string& value);
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_lastsizeprecision(ArgT0&& arg0, ArgT... args);
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_lastsizeprecision(const std::string& value);
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ContractDetails::set_lastpriceprecision(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[1] |= 0x00010000u;
 _impl_.lastpriceprecision_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ContractDetails::_internal_set_lastpriceprecision(const std::string& value) {
  _impl_._has_bits_[1] |= 0x00010000u;
  _impl_.lastpriceprecision_.Set(value, GetArenaForAllocation());
}
inline std::string* ContractDetails::_internal_mutable_lastpriceprecision() {
  _impl_._has_bits_[1] |= 0x00010000u;
  return _impl_.lastpriceprecision_.Mutable(GetArenaForAllocation());
}
inline std::string* ContractDetails::release_lastpriceprecision() {
  ...
  _impl_._has_bits_[1] &= ~0x00010000u;
  auto* p = _impl_.lastpriceprecision_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.lastpriceprecision_.IsDefault()) {
    _impl_.lastpriceprecision_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void ContractDetails::set_allocated_lastpriceprecision(std::string* lastpriceprecision) {
  ...
  _impl_.lastpriceprecision_.SetAllocated(lastpriceprecision, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.lastpriceprecision_.IsDefault()) {
    _impl_.lastpriceprecision_.Set("", GetArenaForAllocation());
  }
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ContractDetails::set_lastsizeprecision(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[1] |= 0x00020000u;
 _impl_.lastsizeprecision_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ContractDetails::_internal_set_lastsizeprecision(const std::string& value) {
  _impl_._has_bits_[1] |= 0x00020000u;
  _impl_.lastsizeprecision_.Set(value, GetArenaForAllocation());
}
inline std::string* ContractDetails::_internal_mutable_lastsizeprecision() {
  _impl_._has_bits_[1] |= 0x00020000u;
  return _impl_.lastsizeprecision_.Mutable(GetArenaForAllocation());
}
inline std::string* ContractDetails::release_lastsizeprecision() {
  ...
  _impl_._has_bits_[1] &= ~0x00020000u;
  auto* p = _impl_.lastsizeprecision_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.lastsizeprecision_.IsDefault()) {
    _impl_.lastsizeprecision_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void ContractDetails::set_allocated_lastsizeprecision(std::string* lastsizeprecision) {
  ...
  _impl_.lastsizeprecision_.SetAllocated(lastsizeprecision, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.lastsizeprecision_.IsDefault()) {
    _impl_.lastsizeprecision_.Set("", GetArenaForAllocation());
  }

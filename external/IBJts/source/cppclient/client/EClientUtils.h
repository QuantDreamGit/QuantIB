...
public:
	...
	static protobuf::PlaceOrderRequest createPlaceOrderRequestProto(int id, const Contract& contract, const Order& order);
	...
	static protobuf::DeltaNeutralContract createDeltaNeutralContractProto(const DeltaNeutralContract& deltaNeutralContract);
	...
	static protobuf::CancelOrderRequest createCancelOrderRequestProto(int id, const OrderCancel& orderCancel);

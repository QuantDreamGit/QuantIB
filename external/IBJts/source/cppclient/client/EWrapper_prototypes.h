...
virtual void tickPrice(int reqId, TickType field, double price, const TickAttrib& attrib) EWRAPPER_VIRTUAL_IMPL;
virtual void tickSize(int reqId, TickType field, Decimal size) EWRAPPER_VIRTUAL_IMPL;
virtual void tickOptionComputation(int reqId, TickType tickType, int tickAttrib, double impliedVol, double delta,
	double optPrice, double pvDividend, double gamma, double vega, double theta, double undPrice) EWRAPPER_VIRTUAL_IMPL;
virtual void tickGeneric(int reqId, TickType tickType, double value) EWRAPPER_VIRTUAL_IMPL;
virtual void tickString(int reqId, TickType tickType, const std::string& value) EWRAPPER_VIRTUAL_IMPL;
virtual void tickEFP(int reqId, TickType tickType, double basisPoints, const std::string& formattedBasisPoints,
...
virtual void orderStatus(int orderId, const std::string& status, Decimal filled,
...
virtual void openOrder(int orderId, const Contract&, const Order&, const OrderState&) EWRAPPER_VIRTUAL_IMPL;
...
virtual void nextValidId(int orderId) EWRAPPER_VIRTUAL_IMPL;
...
virtual void updateMktDepth(int reqId, int position, int operation, int side,
	double price, Decimal size) EWRAPPER_VIRTUAL_IMPL;
virtual void updateMktDepthL2(int reqId, int position, const std::string& marketMaker, int operation,
...
virtual void historicalData(int reqId, const Bar& bar) EWRAPPER_VIRTUAL_IMPL;
...
virtual void realtimeBar(int reqId, long long time, double open, double high, double low, double close,
	Decimal volume, Decimal wap, int count) EWRAPPER_VIRTUAL_IMPL;
virtual void currentTime(long long time) EWRAPPER_VIRTUAL_IMPL;
...
virtual void marketDataType(int reqId, int marketDataType) EWRAPPER_VIRTUAL_IMPL;
...
virtual void tickNews(int reqId, time_t timeStamp, const std::string& providerCode, const std::string& articleId, const std::string& headline, const std::string& extraData) EWRAPPER_VIRTUAL_IMPL;
virtual void smartComponents(int reqId, const SmartComponentsMap& theMap) EWRAPPER_VIRTUAL_IMPL;
virtual void tickReqParams(int reqId, double minTick, const std::string& bboExchange, int snapshotPermissions) EWRAPPER_VIRTUAL_IMPL;
...
virtual void historicalDataUpdate(int reqId, const Bar& bar) EWRAPPER_VIRTUAL_IMPL;

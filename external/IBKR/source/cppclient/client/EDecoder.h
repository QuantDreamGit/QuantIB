...
const int MIN_SERVER_VER_USE_PRECISION_FROM_SEC_DEF      = 224;
const int MIN_SERVER_VER_ODD_LOT_BID_ASK_QUOTES          = 225;
...
const int MAX_CLIENT_VER = MIN_SERVER_VER_ODD_LOT_BID_ASK_QUOTES;

enum IncomingMsgId : int {
    TICK_PRICE                               = 1,
    TICK_SIZE                                = 2,
    ORDER_STATUS                             = 3,
    ERR_MSG                                  = 4,

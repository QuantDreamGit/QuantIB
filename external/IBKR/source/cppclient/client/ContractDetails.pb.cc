...
PROTOBUF_CONSTEXPR ContractDetails::ContractDetails(
  ...
  , /*decltype(_impl_.lastpriceprecision_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.lastsizeprecision_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 10, 80, -1, sizeof(::protobuf::ContractDetails)},
};
...
const ::_pbi::DescriptorTable descriptor_table_ContractDetails_2eproto = {
    false, false, 3218, descriptor_table_protodef_ContractDetails_2eproto,
...
ContractDetails::ContractDetails(const ContractDetails& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.lastpriceprecision_){}
    , decltype(_impl_.lastsizeprecision_){}
  ...
  _impl_.lastpriceprecision_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.lastpriceprecision_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_lastpriceprecision()) {
    _this->_impl_.lastpriceprecision_.Set(from._internal_lastpriceprecision(), 
      _this->GetArenaForAllocation());
  }
  _impl_.lastsizeprecision_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.lastsizeprecision_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_lastsizeprecision()) {
    _this->_impl_.lastsizeprecision_.Set(from._internal_lastsizeprecision(), 
      _this->GetArenaForAllocation());
  }
...
inline void ContractDetails::SharedDtor() {
  ...
  _impl_.lastpriceprecision_.Destroy();
  _impl_.lastsizeprecision_.Destroy();
}
    ...
    switch (tag >> 3) {
      ...
      case 63:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 250)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "protobuf.ContractDetails.lastPricePrecision"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 64:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 2)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "protobuf.ContractDetails.lastSizePrecision"));
        } else
          goto handle_unusual;
        continue;
      default:
...
void ContractDetails::InternalSwap(ContractDetails* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.lastpriceprecision_, lhs_arena,
      &other->_impl_.lastpriceprecision_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.lastsizeprecision_, lhs_arena,
      &other->_impl_.lastsizeprecision_, rhs_arena
  );

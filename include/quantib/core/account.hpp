...
struct UpdateAttribute {
	...
	UpdateAttribute(const std::string& key_, const std::string& value_, const std::string& currency_,
...
struct PortfolioPosition {
	...
	PortfolioPosition(const Contract& contract_, const Decimal position_, const double market_price_,
	                  const double market_value_, const double avg_cost_, const double unrealized_pnl_,
	                  const double realized_pnl_)
